...
const Controls: React.FC<Props> = (props) => {
        ...
        if(props.lifeCycleState){
          ...
          //符号保有しているか判定
            if(props.operatorState){
                ...
                if(float){
                    preserve = preserve + floatPreserve + n;
                    ...
                    //画面上に小数点を表示
                    props.dis_num(Number(preserve.replace(/,/g, "")).toLocaleString() + floatPreserve + '0');
                    props.formula(x + Number(preserve.replace(/,/g, "")).toLocaleString() + floatPreserve + '0');
                    float = false;
    ...
    //float--------------------------------------------------------
    const addFloat = function(f: string): void{

        preserve = Number(preserve).toLocaleString();
        floatPreserve = f;
        result = '';
        ...
        props.dis_num(preserve + floatPreserve);
        props.formula(result + preserve + floatPreserve);
        float = true;
    }
        ...
        <div id="Controls">
            ...
            <div className="l_content">
                ...
                <div className="l_content_bottom">
                    ...
                    <Button data={'.'} internalData={'.'} func={() => addFloat('.')} />
                </div>
